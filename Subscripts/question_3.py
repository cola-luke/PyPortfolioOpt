...
## Look how to construct new dataframe using only some columns.
## I am now doing it with 10 "random" securities, I'll just make sure that they are "full" with values just to be sure.
